...
type _CategoryMetadataConnectionsChannels CategoryMetadataConnectionsChannels
...
func (o *CategoryMetadataConnectionsChannels) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMetadataConnectionsChannels := _CategoryMetadataConnectionsChannels{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCategoryMetadataConnectionsChannels)

	if err != nil {
		return err
	}

	*o = CategoryMetadataConnectionsChannels(varCategoryMetadataConnectionsChannels)
