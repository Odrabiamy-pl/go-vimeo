...
type _VideoMetadataInteractionsAskAi VideoMetadataInteractionsAskAi
...
func (o *VideoMetadataInteractionsAskAi) UnmarshalJSON(data []byte) (err error) {
	...
	varVideoMetadataInteractionsAskAi := _VideoMetadataInteractionsAskAi{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVideoMetadataInteractionsAskAi)

	if err != nil {
		return err
	}

	*o = VideoMetadataInteractionsAskAi(varVideoMetadataInteractionsAskAi)
