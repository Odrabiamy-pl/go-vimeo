...
type _ProjectMetadataInteractionsAddSubfolder ProjectMetadataInteractionsAddSubfolder
...
func (o *ProjectMetadataInteractionsAddSubfolder) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectMetadataInteractionsAddSubfolder := _ProjectMetadataInteractionsAddSubfolder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProjectMetadataInteractionsAddSubfolder)

	if err != nil {
		return err
	}

	*o = ProjectMetadataInteractionsAddSubfolder(varProjectMetadataInteractionsAddSubfolder)
