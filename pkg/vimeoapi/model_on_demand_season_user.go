...
// checks if the OnDemandSeasonUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnDemandSeasonUser{}

// OnDemandSeasonUser The creator of the season's On Demand page.
...
// NewOnDemandSeasonUserWithDefaults instantiates a new OnDemandSeasonUser object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOnDemandSeasonUserWithDefaults() *OnDemandSeasonUser {
	this := OnDemandSeasonUser{}
	return &this
}

// GetAccount returns the Account field value
func (o *OnDemandSeasonUser) GetAccount() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *OnDemandSeasonUser) GetAccountOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetAccount(v string) {
	o.Account = v
}

// GetAvailableForHire returns the AvailableForHire field value
func (o *OnDemandSeasonUser) GetAvailableForHire() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetAvailableForHireOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetAvailableForHire(v bool) {
	o.AvailableForHire = v
}

// GetBio returns the Bio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandSeasonUser) GetBio() string {
...
func (o *OnDemandSeasonUser) GetBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetBio(v string) {
	o.Bio.Set(&v)
}

// GetCanWorkRemotely returns the CanWorkRemotely field value
func (o *OnDemandSeasonUser) GetCanWorkRemotely() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetCanWorkRemotelyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetCanWorkRemotely(v bool) {
	o.CanWorkRemotely = v
}

// GetCapabilities returns the Capabilities field value
func (o *OnDemandSeasonUser) GetCapabilities() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetCapabilitiesOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *OnDemandSeasonUser) SetCapabilities(v map[string]interface{}) {
	o.Capabilities = v
}

// GetClients returns the Clients field value
func (o *OnDemandSeasonUser) GetClients() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetClientsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetClients(v string) {
	o.Clients = v
}

// GetContentFilter returns the ContentFilter field value if set, zero value otherwise.
func (o *OnDemandSeasonUser) GetContentFilter() []string {
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetContentFilterOk() ([]string, bool) {
	if o == nil || IsNil(o.ContentFilter) {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) HasContentFilter() bool {
	if o != nil && !IsNil(o.ContentFilter) {
		return true
	}
...
func (o *OnDemandSeasonUser) SetContentFilter(v []string) {
	o.ContentFilter = v
}

// GetCreatedTime returns the CreatedTime field value
func (o *OnDemandSeasonUser) GetCreatedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetCreatedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetCreatedTime(v string) {
	o.CreatedTime = v
}

// GetGender returns the Gender field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandSeasonUser) GetGender() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandSeasonUser) GetGenderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetGender(v string) {
	o.Gender.Set(&v)
}

// GetHasInvalidEmail returns the HasInvalidEmail field value
func (o *OnDemandSeasonUser) GetHasInvalidEmail() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetHasInvalidEmailOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetHasInvalidEmail(v bool) {
	o.HasInvalidEmail = v
}

// GetIsExpert returns the IsExpert field value
func (o *OnDemandSeasonUser) GetIsExpert() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetIsExpertOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetIsExpert(v bool) {
	o.IsExpert = v
}

// GetLink returns the Link field value
func (o *OnDemandSeasonUser) GetLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Link, true
...
func (o *OnDemandSeasonUser) SetLink(v string) {
	o.Link = v
}

// GetLocation returns the Location field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandSeasonUser) GetLocation() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandSeasonUser) GetLocationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetLocation(v string) {
	o.Location.Set(&v)
}
...
func (o *OnDemandSeasonUser) GetLocationDetails() UserLocationDetails {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandSeasonUser) GetLocationDetailsOk() (*UserLocationDetails, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetLocationDetails(v UserLocationDetails) {
	o.LocationDetails.Set(&v)
}

// GetMetadata returns the Metadata field value
func (o *OnDemandSeasonUser) GetMetadata() UserMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetMetadataOk() (*UserMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetMetadata(v UserMetadata) {
	o.Metadata = v
}

// GetName returns the Name field value
func (o *OnDemandSeasonUser) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *OnDemandSeasonUser) SetName(v string) {
	o.Name = v
}

// GetPictures returns the Pictures field value
func (o *OnDemandSeasonUser) GetPictures() Picture {
	if o == nil {
		var ret Picture
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetPicturesOk() (*Picture, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetPictures(v Picture) {
	o.Pictures = v
}

// GetPreferences returns the Preferences field value
func (o *OnDemandSeasonUser) GetPreferences() UserPreferences {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetPreferencesOk() (*UserPreferences, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetPreferences(v UserPreferences) {
	o.Preferences = v
}

// GetResourceKey returns the ResourceKey field value
func (o *OnDemandSeasonUser) GetResourceKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetResourceKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetResourceKey(v string) {
	o.ResourceKey = v
}

// GetShortBio returns the ShortBio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandSeasonUser) GetShortBio() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandSeasonUser) GetShortBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandSeasonUser) GetSkillsOk() ([]Skill, bool) {
...
func (o *OnDemandSeasonUser) SetSkills(v []Skill) {
	o.Skills = v
}

// GetUploadQuota returns the UploadQuota field value
func (o *OnDemandSeasonUser) GetUploadQuota() UserUploadQuota {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetUploadQuotaOk() (*UserUploadQuota, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetUploadQuota(v UserUploadQuota) {
	o.UploadQuota = v
}

// GetUri returns the Uri field value
func (o *OnDemandSeasonUser) GetUri() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uri, true
...
func (o *OnDemandSeasonUser) SetUri(v string) {
	o.Uri = v
}

// GetWebsites returns the Websites field value
func (o *OnDemandSeasonUser) GetWebsites() []UserWebsitesInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandSeasonUser) GetWebsitesOk() ([]UserWebsitesInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandSeasonUser) SetWebsites(v []UserWebsitesInner) {
	o.Websites = v
}

func (o OnDemandSeasonUser) MarshalJSON() ([]byte, error) {
...
func (o OnDemandSeasonUser) ToMap() (map[string]interface{}, error) {
...
func (o *OnDemandSeasonUser) UnmarshalJSON(data []byte) (err error) {
	...
	varOnDemandSeasonUser := _OnDemandSeasonUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOnDemandSeasonUser)

	if err != nil {
		return err
	}

	*o = OnDemandSeasonUser(varOnDemandSeasonUser)

	return err
}

type NullableOnDemandSeasonUser struct {
	value *OnDemandSeasonUser
	isSet bool
}

func (v NullableOnDemandSeasonUser) Get() *OnDemandSeasonUser {
	return v.value
}

func (v *NullableOnDemandSeasonUser) Set(val *OnDemandSeasonUser) {
	v.value = val
	v.isSet = true
}

func (v NullableOnDemandSeasonUser) IsSet() bool {
	return v.isSet
}

func (v *NullableOnDemandSeasonUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOnDemandSeasonUser(val *OnDemandSeasonUser) *NullableOnDemandSeasonUser {
	return &NullableOnDemandSeasonUser{value: val, isSet: true}
}

func (v NullableOnDemandSeasonUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOnDemandSeasonUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
