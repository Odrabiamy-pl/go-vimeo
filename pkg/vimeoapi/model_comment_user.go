...
// checks if the CommentUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommentUser{}
...
// NewCommentUserWithDefaults instantiates a new CommentUser object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCommentUserWithDefaults() *CommentUser {
	this := CommentUser{}
	return &this
}

// GetAccount returns the Account field value
func (o *CommentUser) GetAccount() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CommentUser) GetAccountOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetAccount(v string) {
	o.Account = v
}

// GetAvailableForHire returns the AvailableForHire field value
func (o *CommentUser) GetAvailableForHire() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetAvailableForHireOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetAvailableForHire(v bool) {
	o.AvailableForHire = v
}

// GetBio returns the Bio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *CommentUser) GetBio() string {
...
func (o *CommentUser) GetBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetBio(v string) {
	o.Bio.Set(&v)
}

// GetCanWorkRemotely returns the CanWorkRemotely field value
func (o *CommentUser) GetCanWorkRemotely() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetCanWorkRemotelyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetCanWorkRemotely(v bool) {
	o.CanWorkRemotely = v
}

// GetCapabilities returns the Capabilities field value
func (o *CommentUser) GetCapabilities() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetCapabilitiesOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *CommentUser) SetCapabilities(v map[string]interface{}) {
	o.Capabilities = v
}

// GetClients returns the Clients field value
func (o *CommentUser) GetClients() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetClientsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetContentFilterOk() ([]string, bool) {
	if o == nil || IsNil(o.ContentFilter) {
		return nil, false
	}
...
func (o *CommentUser) HasContentFilter() bool {
	if o != nil && !IsNil(o.ContentFilter) {
		return true
	}
...
func (o *CommentUser) SetContentFilter(v []string) {
	o.ContentFilter = v
}

// GetCreatedTime returns the CreatedTime field value
func (o *CommentUser) GetCreatedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetCreatedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetCreatedTime(v string) {
	o.CreatedTime = v
}

// GetGender returns the Gender field value
// If the value is explicit nil, the zero value for string will be returned
func (o *CommentUser) GetGender() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CommentUser) GetGenderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetGender(v string) {
	o.Gender.Set(&v)
}

// GetHasInvalidEmail returns the HasInvalidEmail field value
func (o *CommentUser) GetHasInvalidEmail() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetHasInvalidEmailOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetHasInvalidEmail(v bool) {
	o.HasInvalidEmail = v
}

// GetIsExpert returns the IsExpert field value
func (o *CommentUser) GetIsExpert() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetIsExpertOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetIsExpert(v bool) {
	o.IsExpert = v
}

// GetLink returns the Link field value
func (o *CommentUser) GetLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Link, true
...
func (o *CommentUser) SetLink(v string) {
	o.Link = v
}

// GetLocation returns the Location field value
// If the value is explicit nil, the zero value for string will be returned
func (o *CommentUser) GetLocation() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CommentUser) GetLocationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetLocation(v string) {
	o.Location.Set(&v)
}
...
func (o *CommentUser) GetLocationDetails() UserLocationDetails {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CommentUser) GetLocationDetailsOk() (*UserLocationDetails, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetLocationDetails(v UserLocationDetails) {
	o.LocationDetails.Set(&v)
}

// GetMetadata returns the Metadata field value
func (o *CommentUser) GetMetadata() UserMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetMetadataOk() (*UserMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetMetadata(v UserMetadata) {
	o.Metadata = v
}

// GetName returns the Name field value
func (o *CommentUser) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *CommentUser) SetName(v string) {
	o.Name = v
}

// GetPictures returns the Pictures field value
func (o *CommentUser) GetPictures() Picture {
	if o == nil {
		var ret Picture
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetPicturesOk() (*Picture, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetPictures(v Picture) {
	o.Pictures = v
}

// GetPreferences returns the Preferences field value
func (o *CommentUser) GetPreferences() UserPreferences {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetPreferencesOk() (*UserPreferences, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetPreferences(v UserPreferences) {
	o.Preferences = v
}

// GetResourceKey returns the ResourceKey field value
func (o *CommentUser) GetResourceKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetResourceKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetResourceKey(v string) {
	o.ResourceKey = v
}

// GetShortBio returns the ShortBio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *CommentUser) GetShortBio() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CommentUser) GetShortBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CommentUser) GetSkillsOk() ([]Skill, bool) {
...
func (o *CommentUser) SetSkills(v []Skill) {
	o.Skills = v
}

// GetUploadQuota returns the UploadQuota field value
func (o *CommentUser) GetUploadQuota() UserUploadQuota {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetUploadQuotaOk() (*UserUploadQuota, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetUploadQuota(v UserUploadQuota) {
	o.UploadQuota = v
}

// GetUri returns the Uri field value
func (o *CommentUser) GetUri() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uri, true
...
func (o *CommentUser) SetUri(v string) {
	o.Uri = v
}

// GetWebsites returns the Websites field value
func (o *CommentUser) GetWebsites() []UserWebsitesInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CommentUser) GetWebsitesOk() ([]UserWebsitesInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommentUser) SetWebsites(v []UserWebsitesInner) {
	o.Websites = v
}

func (o CommentUser) MarshalJSON() ([]byte, error) {
...
func (o CommentUser) ToMap() (map[string]interface{}, error) {
...
func (o *CommentUser) UnmarshalJSON(data []byte) (err error) {
	...
	varCommentUser := _CommentUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommentUser)

	if err != nil {
		return err
	}

	*o = CommentUser(varCommentUser)

	return err
}

type NullableCommentUser struct {
	value *CommentUser
	isSet bool
}

func (v NullableCommentUser) Get() *CommentUser {
	return v.value
}

func (v *NullableCommentUser) Set(val *CommentUser) {
	v.value = val
	v.isSet = true
}

func (v NullableCommentUser) IsSet() bool {
	return v.isSet
}

func (v *NullableCommentUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommentUser(val *CommentUser) *NullableCommentUser {
	return &NullableCommentUser{value: val, isSet: true}
}

func (v NullableCommentUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommentUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
