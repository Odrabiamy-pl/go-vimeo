...
type _DisabledVideoPropertiesEditPrivacy DisabledVideoPropertiesEditPrivacy
...
func (o *DisabledVideoPropertiesEditPrivacy) UnmarshalJSON(data []byte) (err error) {
	...
	varDisabledVideoPropertiesEditPrivacy := _DisabledVideoPropertiesEditPrivacy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDisabledVideoPropertiesEditPrivacy)

	if err != nil {
		return err
	}

	*o = DisabledVideoPropertiesEditPrivacy(varDisabledVideoPropertiesEditPrivacy)
