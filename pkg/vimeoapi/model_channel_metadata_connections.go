...
type _ChannelMetadataConnections ChannelMetadataConnections
...
func (o *ChannelMetadataConnections) UnmarshalJSON(data []byte) (err error) {
	...
	varChannelMetadataConnections := _ChannelMetadataConnections{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChannelMetadataConnections)

	if err != nil {
		return err
	}

	*o = ChannelMetadataConnections(varChannelMetadataConnections)
