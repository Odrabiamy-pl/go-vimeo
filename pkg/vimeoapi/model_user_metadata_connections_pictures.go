...
type _UserMetadataConnectionsPictures UserMetadataConnectionsPictures
...
func (o *UserMetadataConnectionsPictures) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMetadataConnectionsPictures := _UserMetadataConnectionsPictures{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMetadataConnectionsPictures)

	if err != nil {
		return err
	}

	*o = UserMetadataConnectionsPictures(varUserMetadataConnectionsPictures)
