...
type _LiveEventInteractionToolsSettingsInner LiveEventInteractionToolsSettingsInner
...
func (o *LiveEventInteractionToolsSettingsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varLiveEventInteractionToolsSettingsInner := _LiveEventInteractionToolsSettingsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLiveEventInteractionToolsSettingsInner)

	if err != nil {
		return err
	}

	*o = LiveEventInteractionToolsSettingsInner(varLiveEventInteractionToolsSettingsInner)
