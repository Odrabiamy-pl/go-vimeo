...
type _CreateWebinarAlt1Request CreateWebinarAlt1Request
...
func (o *CreateWebinarAlt1Request) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateWebinarAlt1Request := _CreateWebinarAlt1Request{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateWebinarAlt1Request)

	if err != nil {
		return err
	}

	*o = CreateWebinarAlt1Request(varCreateWebinarAlt1Request)
