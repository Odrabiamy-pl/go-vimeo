...
type _WebinarEmailQuota WebinarEmailQuota
...
func (o *WebinarEmailQuota) UnmarshalJSON(data []byte) (err error) {
	...
	varWebinarEmailQuota := _WebinarEmailQuota{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebinarEmailQuota)

	if err != nil {
		return err
	}

	*o = WebinarEmailQuota(varWebinarEmailQuota)
