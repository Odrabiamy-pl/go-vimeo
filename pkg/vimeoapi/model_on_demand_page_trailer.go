...
// checks if the OnDemandPageTrailer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnDemandPageTrailer{}

// OnDemandPageTrailer The trailer for the On Demand page.
...
type _OnDemandPageTrailer OnDemandPageTrailer

// NewOnDemandPageTrailer instantiates a new OnDemandPageTrailer object
...
// NewOnDemandPageTrailerWithDefaults instantiates a new OnDemandPageTrailer object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOnDemandPageTrailerWithDefaults() *OnDemandPageTrailer {
	this := OnDemandPageTrailer{}
	return &this
}

// GetAllowedPrivacies returns the AllowedPrivacies field value
func (o *OnDemandPageTrailer) GetAllowedPrivacies() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *OnDemandPageTrailer) GetAllowedPrivaciesOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetAllowedPrivacies(v []string) {
	o.AllowedPrivacies = v
}

// GetApp returns the App field value
func (o *OnDemandPageTrailer) GetApp() ApiApp {
	if o == nil {
		var ret ApiApp
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetAppOk() (*ApiApp, bool) {
	if o == nil {
		return nil, false
	}
	return &o.App, true
...
func (o *OnDemandPageTrailer) SetApp(v ApiApp) {
	o.App = v
}

// GetCanMoveToProject returns the CanMoveToProject field value
// If the value is explicit nil, the zero value for bool will be returned
func (o *OnDemandPageTrailer) GetCanMoveToProject() bool {
...
func (o *OnDemandPageTrailer) GetCanMoveToProjectOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetCanMoveToProject(v bool) {
	o.CanMoveToProject.Set(&v)
}

// GetCategories returns the Categories field value
func (o *OnDemandPageTrailer) GetCategories() []Category {
	if o == nil {
		var ret []Category
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetCategoriesOk() ([]Category, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetCategories(v []Category) {
	o.Categories = v
}

// GetContentRating returns the ContentRating field value
func (o *OnDemandPageTrailer) GetContentRating() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetContentRatingOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetContentRating(v []string) {
	o.ContentRating = v
}

// GetContentRatingClass returns the ContentRatingClass field value
func (o *OnDemandPageTrailer) GetContentRatingClass() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetContentRatingClassOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetContentRatingClass(v string) {
	o.ContentRatingClass = v
}

// GetContext returns the Context field value
func (o *OnDemandPageTrailer) GetContext() VideoContext {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetContextOk() (*VideoContext, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetContext(v VideoContext) {
	o.Context = v
}

// GetCreatedTime returns the CreatedTime field value
func (o *OnDemandPageTrailer) GetCreatedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetCreatedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetCreatedTime(v string) {
	o.CreatedTime = v
}

// GetCustomUrl returns the CustomUrl field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageTrailer) GetCustomUrl() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetCustomUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetCustomUrl(v string) {
	o.CustomUrl.Set(&v)
}

// GetDescription returns the Description field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageTrailer) GetDescription() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetDescriptionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetDescription(v string) {
	o.Description.Set(&v)
}

// GetDescriptionHtml returns the DescriptionHtml field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageTrailer) GetDescriptionHtml() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetDescriptionHtmlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetDescriptionRichOk() (*string, bool) {
	if o == nil || IsNil(o.DescriptionRich) {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasDescriptionRich() bool {
	if o != nil && !IsNil(o.DescriptionRich) {
		return true
	}
...
func (o *OnDemandPageTrailer) SetDescriptionRich(v string) {
	o.DescriptionRich = &v
}

// GetDisabledProperties returns the DisabledProperties field value if set, zero value otherwise.
func (o *OnDemandPageTrailer) GetDisabledProperties() DisabledVideoProperties {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetDisabledPropertiesOk() (*DisabledVideoProperties, bool) {
	if o == nil || IsNil(o.DisabledProperties) {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasDisabledProperties() bool {
	if o != nil && !IsNil(o.DisabledProperties) {
		return true
	}
...
func (o *OnDemandPageTrailer) SetDisabledProperties(v DisabledVideoProperties) {
	o.DisabledProperties = &v
}

// GetDownload returns the Download field value
func (o *OnDemandPageTrailer) GetDownload() []VideoFile {
	if o == nil {
		var ret []VideoFile
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetDownloadOk() ([]VideoFile, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetDownload(v []VideoFile) {
	o.Download = v
}

// GetDuration returns the Duration field value
func (o *OnDemandPageTrailer) GetDuration() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetDurationOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetDuration(v float32) {
	o.Duration = v
}

// GetEditSession returns the EditSession field value if set, zero value otherwise.
func (o *OnDemandPageTrailer) GetEditSession() EditingSession {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetEditSessionOk() (*EditingSession, bool) {
	if o == nil || IsNil(o.EditSession) {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasEditSession() bool {
	if o != nil && !IsNil(o.EditSession) {
		return true
	}
...
func (o *OnDemandPageTrailer) SetEditSession(v EditingSession) {
	o.EditSession = &v
}

// GetEmbed returns the Embed field value
func (o *OnDemandPageTrailer) GetEmbed() EmbedSettings {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetEmbedOk() (*EmbedSettings, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Embed, true
...
func (o *OnDemandPageTrailer) SetEmbed(v EmbedSettings) {
	o.Embed = v
}

// GetFiles returns the Files field value
func (o *OnDemandPageTrailer) GetFiles() []VideoFile {
	if o == nil {
		var ret []VideoFile
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetFilesOk() ([]VideoFile, bool) {
	if o == nil {
		return nil, false
	}
	return o.Files, true
...
func (o *OnDemandPageTrailer) SetFiles(v []VideoFile) {
	o.Files = v
}

// GetHasAudio returns the HasAudio field value
func (o *OnDemandPageTrailer) GetHasAudio() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetHasAudioOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetHasAudio(v bool) {
	o.HasAudio = v
}

// GetHasAudioTracks returns the HasAudioTracks field value
func (o *OnDemandPageTrailer) GetHasAudioTracks() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetHasAudioTracksOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetHasAudioTracks(v bool) {
	o.HasAudioTracks = v
}

// GetHasChapters returns the HasChapters field value
func (o *OnDemandPageTrailer) GetHasChapters() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetHasChaptersOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetHasChapters(v bool) {
	o.HasChapters = v
}

// GetHasInteractive returns the HasInteractive field value
func (o *OnDemandPageTrailer) GetHasInteractive() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetHasInteractiveOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetHasInteractive(v bool) {
	o.HasInteractive = v
}

// GetHasTextTracks returns the HasTextTracks field value
func (o *OnDemandPageTrailer) GetHasTextTracks() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetHasTextTracksOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetHasTextTracks(v bool) {
	o.HasTextTracks = v
}

// GetHeight returns the Height field value
func (o *OnDemandPageTrailer) GetHeight() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetHeightOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetHeight(v float32) {
	o.Height = v
}

// GetIsCopyrightRestricted returns the IsCopyrightRestricted field value
func (o *OnDemandPageTrailer) GetIsCopyrightRestricted() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetIsCopyrightRestrictedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetIsCopyrightRestricted(v bool) {
	o.IsCopyrightRestricted = v
}

// GetIsFree returns the IsFree field value if set, zero value otherwise.
func (o *OnDemandPageTrailer) GetIsFree() bool {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetIsFreeOk() (*bool, bool) {
	if o == nil || IsNil(o.IsFree) {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasIsFree() bool {
	if o != nil && !IsNil(o.IsFree) {
		return true
	}
...
func (o *OnDemandPageTrailer) SetIsFree(v bool) {
	o.IsFree = &v
}

// GetIsPlayable returns the IsPlayable field value
func (o *OnDemandPageTrailer) GetIsPlayable() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetIsPlayableOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetIsPlayable(v bool) {
	o.IsPlayable = v
}

// GetLanguage returns the Language field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageTrailer) GetLanguage() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetLanguageOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetLanguage(v string) {
	o.Language.Set(&v)
}
...
func (o *OnDemandPageTrailer) GetLastUserActionEventDate() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetLastUserActionEventDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasLastUserActionEventDate() bool {
...
func (o *OnDemandPageTrailer) UnsetLastUserActionEventDate() {
	o.LastUserActionEventDate.Unset()
}

// GetLicense returns the License field value
func (o *OnDemandPageTrailer) GetLicense() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetLicenseOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetLicense(v string) {
	o.License = v
}

// GetLink returns the Link field value
func (o *OnDemandPageTrailer) GetLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Link, true
...
func (o *OnDemandPageTrailer) SetLink(v string) {
	o.Link = v
}

// GetManageLink returns the ManageLink field value if set, zero value otherwise.
func (o *OnDemandPageTrailer) GetManageLink() string {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetManageLinkOk() (*string, bool) {
	if o == nil || IsNil(o.ManageLink) {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasManageLink() bool {
	if o != nil && !IsNil(o.ManageLink) {
		return true
	}
...
func (o *OnDemandPageTrailer) GetModifiedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetModifiedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetModifiedTime(v string) {
	o.ModifiedTime = v
}

// GetName returns the Name field value
func (o *OnDemandPageTrailer) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *OnDemandPageTrailer) SetName(v string) {
	o.Name = v
}

// GetOriginVariableFrameResolution returns the OriginVariableFrameResolution field value
func (o *OnDemandPageTrailer) GetOriginVariableFrameResolution() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetOriginVariableFrameResolutionOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetOriginVariableFrameResolution(v bool) {
...
func (o *OnDemandPageTrailer) GetParentFolder() VideoParentFolder {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetParentFolderOk() (*VideoParentFolder, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasParentFolder() bool {
...
func (o *OnDemandPageTrailer) UnsetParentFolder() {
	o.ParentFolder.Unset()
}

// GetPassword returns the Password field value if set, zero value otherwise.
func (o *OnDemandPageTrailer) GetPassword() string {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetPasswordOk() (*string, bool) {
	if o == nil || IsNil(o.Password) {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) HasPassword() bool {
	if o != nil && !IsNil(o.Password) {
		return true
	}
...
func (o *OnDemandPageTrailer) SetPassword(v string) {
	o.Password = &v
}

// GetPictures returns the Pictures field value
func (o *OnDemandPageTrailer) GetPictures() Picture {
	if o == nil {
		var ret Picture
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetPicturesOk() (*Picture, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetPictures(v Picture) {
	o.Pictures = v
}

// GetPlay returns the Play field value if set, zero value otherwise.
func (o *OnDemandPageTrailer) GetPlay() Play {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetPlayOk() (*Play, bool) {
	if o == nil || IsNil(o.Play) {
		return nil, false
	}
	return o.Play, true
...
func (o *OnDemandPageTrailer) HasPlay() bool {
	if o != nil && !IsNil(o.Play) {
		return true
	}
...
func (o *OnDemandPageTrailer) SetPlay(v Play) {
	o.Play = &v
}

// GetPlayerEmbedUrl returns the PlayerEmbedUrl field value
func (o *OnDemandPageTrailer) GetPlayerEmbedUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetPlayerEmbedUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetPlayerEmbedUrl(v string) {
	o.PlayerEmbedUrl = v
}

// GetPrivacy returns the Privacy field value
func (o *OnDemandPageTrailer) GetPrivacy() VideoPrivacy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetPrivacyOk() (*VideoPrivacy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetPrivacy(v VideoPrivacy) {
	o.Privacy = v
}

// GetRatingModLocked returns the RatingModLocked field value
func (o *OnDemandPageTrailer) GetRatingModLocked() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetRatingModLockedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetRatingModLocked(v bool) {
	o.RatingModLocked = v
}

// GetReleaseTime returns the ReleaseTime field value
func (o *OnDemandPageTrailer) GetReleaseTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetReleaseTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetReleaseTime(v string) {
	o.ReleaseTime = v
}

// GetResourceKey returns the ResourceKey field value
func (o *OnDemandPageTrailer) GetResourceKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetResourceKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetResourceKey(v string) {
	o.ResourceKey = v
}

// GetShowReviewPage returns the ShowReviewPage field value
// If the value is explicit nil, the zero value for bool will be returned
func (o *OnDemandPageTrailer) GetShowReviewPage() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetShowReviewPageOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetShowReviewPage(v bool) {
	o.ShowReviewPage.Set(&v)
}

// GetShowSvvFooterBanner returns the ShowSvvFooterBanner field value
// If the value is explicit nil, the zero value for bool will be returned
func (o *OnDemandPageTrailer) GetShowSvvFooterBanner() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetShowSvvFooterBannerOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetShowSvvFooterBanner(v bool) {
	o.ShowSvvFooterBanner.Set(&v)
}

// GetShowSvvTimecodedComments returns the ShowSvvTimecodedComments field value
// If the value is explicit nil, the zero value for bool will be returned
func (o *OnDemandPageTrailer) GetShowSvvTimecodedComments() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetShowSvvTimecodedCommentsOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetShowSvvTimecodedComments(v bool) {
	o.ShowSvvTimecodedComments.Set(&v)
}

// GetSpatial returns the Spatial field value
func (o *OnDemandPageTrailer) GetSpatial() VideoSpatial {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetSpatialOk() (*VideoSpatial, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetSpatial(v VideoSpatial) {
	o.Spatial = v
}

// GetStats returns the Stats field value
func (o *OnDemandPageTrailer) GetStats() VideoStats {
	if o == nil {
		var ret VideoStats
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetStatsOk() (*VideoStats, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Stats, true
...
func (o *OnDemandPageTrailer) SetStats(v VideoStats) {
	o.Stats = v
}

// GetStatus returns the Status field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageTrailer) GetStatus() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetStatus(v string) {
	o.Status.Set(&v)
}

// GetTags returns the Tags field value
func (o *OnDemandPageTrailer) GetTags() []Tag {
	if o == nil {
		var ret []Tag
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetTagsOk() ([]Tag, bool) {
	if o == nil {
		return nil, false
	}
	return o.Tags, true
...
func (o *OnDemandPageTrailer) SetTags(v []Tag) {
	o.Tags = v
}
...
func (o *OnDemandPageTrailer) GetTranscode() VideoTranscode {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetTranscodeOk() (*VideoTranscode, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetTranscode(v VideoTranscode) {
	o.Transcode.Set(&v)
}
...
func (o *OnDemandPageTrailer) GetTranscript() VideoTranscript {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetTranscriptOk() (*VideoTranscript, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetTranscript(v VideoTranscript) {
	o.Transcript.Set(&v)
}

// GetType returns the Type field value
func (o *OnDemandPageTrailer) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetUploadOk() (*VideoUpload, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetUpload(v VideoUpload) {
	o.Upload.Set(&v)
}

// GetUploader returns the Uploader field value
func (o *OnDemandPageTrailer) GetUploader() VideoUploader {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetUploaderOk() (*VideoUploader, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetUploader(v VideoUploader) {
	o.Uploader = v
}

// GetUri returns the Uri field value
func (o *OnDemandPageTrailer) GetUri() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uri, true
...
func (o *OnDemandPageTrailer) SetUri(v string) {
	o.Uri = v
}

// GetUser returns the User field value
// If the value is explicit nil, the zero value for VideoUser will be returned
func (o *OnDemandPageTrailer) GetUser() VideoUser {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetUserOk() (*VideoUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetUser(v VideoUser) {
	o.User.Set(&v)
}

// GetVersionTranscodeStatus returns the VersionTranscodeStatus field value
func (o *OnDemandPageTrailer) GetVersionTranscodeStatus() VersionTranscodeStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetVersionTranscodeStatusOk() (*VersionTranscodeStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetVersionTranscodeStatus(v VersionTranscodeStatus) {
...
func (o *OnDemandPageTrailer) GetVod() VideoVod {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageTrailer) GetVodOk() (*VideoVod, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageTrailer) SetVod(v VideoVod) {
	o.Vod.Set(&v)
}

// GetWidth returns the Width field value
func (o *OnDemandPageTrailer) GetWidth() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageTrailer) GetWidthOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Width, true
...
func (o *OnDemandPageTrailer) SetWidth(v float32) {
	o.Width = v
}
...
func (o OnDemandPageTrailer) ToMap() (map[string]interface{}, error) {
...
func (o *OnDemandPageTrailer) UnmarshalJSON(data []byte) (err error) {
	...
	varOnDemandPageTrailer := _OnDemandPageTrailer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOnDemandPageTrailer)

	if err != nil {
		return err
	}

	*o = OnDemandPageTrailer(varOnDemandPageTrailer)

	return err
}

type NullableOnDemandPageTrailer struct {
	value *OnDemandPageTrailer
	isSet bool
}

func (v NullableOnDemandPageTrailer) Get() *OnDemandPageTrailer {
	return v.value
}

func (v *NullableOnDemandPageTrailer) Set(val *OnDemandPageTrailer) {
	v.value = val
	v.isSet = true
}

func (v NullableOnDemandPageTrailer) IsSet() bool {
	return v.isSet
}

func (v *NullableOnDemandPageTrailer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOnDemandPageTrailer(val *OnDemandPageTrailer) *NullableOnDemandPageTrailer {
	return &NullableOnDemandPageTrailer{value: val, isSet: true}
}

func (v NullableOnDemandPageTrailer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOnDemandPageTrailer) UnmarshalJSON(src []byte) error {
	v.isSet = true
