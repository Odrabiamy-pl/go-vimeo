...
type _UserMetadataInteractionsFollow UserMetadataInteractionsFollow
...
func (o *UserMetadataInteractionsFollow) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMetadataInteractionsFollow := _UserMetadataInteractionsFollow{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMetadataInteractionsFollow)

	if err != nil {
		return err
	}

	*o = UserMetadataInteractionsFollow(varUserMetadataInteractionsFollow)
