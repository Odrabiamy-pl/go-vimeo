...
type _DisabledVideoPropertiesEditPrivacyReasonsInner DisabledVideoPropertiesEditPrivacyReasonsInner
...
func (o *DisabledVideoPropertiesEditPrivacyReasonsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varDisabledVideoPropertiesEditPrivacyReasonsInner := _DisabledVideoPropertiesEditPrivacyReasonsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDisabledVideoPropertiesEditPrivacyReasonsInner)

	if err != nil {
		return err
	}

	*o = DisabledVideoPropertiesEditPrivacyReasonsInner(varDisabledVideoPropertiesEditPrivacyReasonsInner)
