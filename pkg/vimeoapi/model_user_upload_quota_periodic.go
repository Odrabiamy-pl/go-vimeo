...
type _UserUploadQuotaPeriodic UserUploadQuotaPeriodic
...
func (o *UserUploadQuotaPeriodic) UnmarshalJSON(data []byte) (err error) {
	...
	varUserUploadQuotaPeriodic := _UserUploadQuotaPeriodic{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserUploadQuotaPeriodic)

	if err != nil {
		return err
	}

	*o = UserUploadQuotaPeriodic(varUserUploadQuotaPeriodic)
