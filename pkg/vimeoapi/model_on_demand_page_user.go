...
// checks if the OnDemandPageUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnDemandPageUser{}

// OnDemandPageUser The user who created the On Demand page.
...
// NewOnDemandPageUserWithDefaults instantiates a new OnDemandPageUser object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOnDemandPageUserWithDefaults() *OnDemandPageUser {
	this := OnDemandPageUser{}
	return &this
}

// GetAccount returns the Account field value
func (o *OnDemandPageUser) GetAccount() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *OnDemandPageUser) GetAccountOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetAccount(v string) {
	o.Account = v
}

// GetAvailableForHire returns the AvailableForHire field value
func (o *OnDemandPageUser) GetAvailableForHire() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetAvailableForHireOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetAvailableForHire(v bool) {
	o.AvailableForHire = v
}

// GetBio returns the Bio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageUser) GetBio() string {
...
func (o *OnDemandPageUser) GetBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetBio(v string) {
	o.Bio.Set(&v)
}

// GetCanWorkRemotely returns the CanWorkRemotely field value
func (o *OnDemandPageUser) GetCanWorkRemotely() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetCanWorkRemotelyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetCanWorkRemotely(v bool) {
	o.CanWorkRemotely = v
}

// GetCapabilities returns the Capabilities field value
func (o *OnDemandPageUser) GetCapabilities() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetCapabilitiesOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *OnDemandPageUser) SetCapabilities(v map[string]interface{}) {
	o.Capabilities = v
}

// GetClients returns the Clients field value
func (o *OnDemandPageUser) GetClients() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetClientsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetClients(v string) {
	o.Clients = v
}

// GetContentFilter returns the ContentFilter field value if set, zero value otherwise.
func (o *OnDemandPageUser) GetContentFilter() []string {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetContentFilterOk() ([]string, bool) {
	if o == nil || IsNil(o.ContentFilter) {
		return nil, false
	}
...
func (o *OnDemandPageUser) HasContentFilter() bool {
	if o != nil && !IsNil(o.ContentFilter) {
		return true
	}
...
func (o *OnDemandPageUser) SetContentFilter(v []string) {
	o.ContentFilter = v
}

// GetCreatedTime returns the CreatedTime field value
func (o *OnDemandPageUser) GetCreatedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetCreatedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetCreatedTime(v string) {
	o.CreatedTime = v
}

// GetGender returns the Gender field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageUser) GetGender() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageUser) GetGenderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetGender(v string) {
	o.Gender.Set(&v)
}

// GetHasInvalidEmail returns the HasInvalidEmail field value
func (o *OnDemandPageUser) GetHasInvalidEmail() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetHasInvalidEmailOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetHasInvalidEmail(v bool) {
	o.HasInvalidEmail = v
}

// GetIsExpert returns the IsExpert field value
func (o *OnDemandPageUser) GetIsExpert() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetIsExpertOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetIsExpert(v bool) {
	o.IsExpert = v
}

// GetLink returns the Link field value
func (o *OnDemandPageUser) GetLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Link, true
...
func (o *OnDemandPageUser) SetLink(v string) {
	o.Link = v
}

// GetLocation returns the Location field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageUser) GetLocation() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageUser) GetLocationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetLocation(v string) {
	o.Location.Set(&v)
}
...
func (o *OnDemandPageUser) GetLocationDetails() UserLocationDetails {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageUser) GetLocationDetailsOk() (*UserLocationDetails, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetLocationDetails(v UserLocationDetails) {
	o.LocationDetails.Set(&v)
}

// GetMetadata returns the Metadata field value
func (o *OnDemandPageUser) GetMetadata() UserMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetMetadataOk() (*UserMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetMetadata(v UserMetadata) {
	o.Metadata = v
}

// GetName returns the Name field value
func (o *OnDemandPageUser) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *OnDemandPageUser) SetName(v string) {
	o.Name = v
}

// GetPictures returns the Pictures field value
func (o *OnDemandPageUser) GetPictures() Picture {
	if o == nil {
		var ret Picture
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetPicturesOk() (*Picture, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetPictures(v Picture) {
	o.Pictures = v
}

// GetPreferences returns the Preferences field value
func (o *OnDemandPageUser) GetPreferences() UserPreferences {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetPreferencesOk() (*UserPreferences, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetPreferences(v UserPreferences) {
	o.Preferences = v
}

// GetResourceKey returns the ResourceKey field value
func (o *OnDemandPageUser) GetResourceKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetResourceKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetResourceKey(v string) {
	o.ResourceKey = v
}

// GetShortBio returns the ShortBio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OnDemandPageUser) GetShortBio() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageUser) GetShortBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OnDemandPageUser) GetSkillsOk() ([]Skill, bool) {
...
func (o *OnDemandPageUser) SetSkills(v []Skill) {
	o.Skills = v
}

// GetUploadQuota returns the UploadQuota field value
func (o *OnDemandPageUser) GetUploadQuota() UserUploadQuota {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetUploadQuotaOk() (*UserUploadQuota, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetUploadQuota(v UserUploadQuota) {
	o.UploadQuota = v
}

// GetUri returns the Uri field value
func (o *OnDemandPageUser) GetUri() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uri, true
...
func (o *OnDemandPageUser) SetUri(v string) {
	o.Uri = v
}

// GetWebsites returns the Websites field value
func (o *OnDemandPageUser) GetWebsites() []UserWebsitesInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OnDemandPageUser) GetWebsitesOk() ([]UserWebsitesInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnDemandPageUser) SetWebsites(v []UserWebsitesInner) {
	o.Websites = v
}

func (o OnDemandPageUser) MarshalJSON() ([]byte, error) {
...
func (o OnDemandPageUser) ToMap() (map[string]interface{}, error) {
...
func (o *OnDemandPageUser) UnmarshalJSON(data []byte) (err error) {
	...
	varOnDemandPageUser := _OnDemandPageUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOnDemandPageUser)

	if err != nil {
		return err
	}

	*o = OnDemandPageUser(varOnDemandPageUser)

	return err
}

type NullableOnDemandPageUser struct {
	value *OnDemandPageUser
	isSet bool
}

func (v NullableOnDemandPageUser) Get() *OnDemandPageUser {
	return v.value
}

func (v *NullableOnDemandPageUser) Set(val *OnDemandPageUser) {
	v.value = val
	v.isSet = true
}

func (v NullableOnDemandPageUser) IsSet() bool {
	return v.isSet
}

func (v *NullableOnDemandPageUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOnDemandPageUser(val *OnDemandPageUser) *NullableOnDemandPageUser {
	return &NullableOnDemandPageUser{value: val, isSet: true}
}

func (v NullableOnDemandPageUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOnDemandPageUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
