...
// checks if the TeamMembershipUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamMembershipUser{}

// TeamMembershipUser The team member. The value of this field is null if the user hasn't joined the team yet.
type TeamMembershipUser struct {
...
// NewTeamMembershipUserWithDefaults instantiates a new TeamMembershipUser object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTeamMembershipUserWithDefaults() *TeamMembershipUser {
	this := TeamMembershipUser{}
	return &this
}

// GetAccount returns the Account field value
func (o *TeamMembershipUser) GetAccount() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *TeamMembershipUser) GetAccountOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetAccount(v string) {
	o.Account = v
}

// GetAvailableForHire returns the AvailableForHire field value
func (o *TeamMembershipUser) GetAvailableForHire() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetAvailableForHireOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetAvailableForHire(v bool) {
	o.AvailableForHire = v
}

// GetBio returns the Bio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *TeamMembershipUser) GetBio() string {
...
func (o *TeamMembershipUser) GetBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetBio(v string) {
	o.Bio.Set(&v)
}

// GetCanWorkRemotely returns the CanWorkRemotely field value
func (o *TeamMembershipUser) GetCanWorkRemotely() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetCanWorkRemotelyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetCanWorkRemotely(v bool) {
	o.CanWorkRemotely = v
}

// GetCapabilities returns the Capabilities field value
func (o *TeamMembershipUser) GetCapabilities() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetCapabilitiesOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *TeamMembershipUser) SetCapabilities(v map[string]interface{}) {
	o.Capabilities = v
}

// GetClients returns the Clients field value
func (o *TeamMembershipUser) GetClients() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetClientsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetClients(v string) {
	o.Clients = v
}

// GetContentFilter returns the ContentFilter field value if set, zero value otherwise.
func (o *TeamMembershipUser) GetContentFilter() []string {
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetContentFilterOk() ([]string, bool) {
	if o == nil || IsNil(o.ContentFilter) {
		return nil, false
	}
...
func (o *TeamMembershipUser) HasContentFilter() bool {
	if o != nil && !IsNil(o.ContentFilter) {
		return true
	}
...
func (o *TeamMembershipUser) SetContentFilter(v []string) {
	o.ContentFilter = v
}

// GetCreatedTime returns the CreatedTime field value
func (o *TeamMembershipUser) GetCreatedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetCreatedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetCreatedTime(v string) {
	o.CreatedTime = v
}

// GetGender returns the Gender field value
// If the value is explicit nil, the zero value for string will be returned
func (o *TeamMembershipUser) GetGender() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TeamMembershipUser) GetGenderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetGender(v string) {
	o.Gender.Set(&v)
}

// GetHasInvalidEmail returns the HasInvalidEmail field value
func (o *TeamMembershipUser) GetHasInvalidEmail() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetHasInvalidEmailOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetHasInvalidEmail(v bool) {
	o.HasInvalidEmail = v
}

// GetIsExpert returns the IsExpert field value
func (o *TeamMembershipUser) GetIsExpert() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetIsExpertOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetIsExpert(v bool) {
	o.IsExpert = v
}

// GetLink returns the Link field value
func (o *TeamMembershipUser) GetLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Link, true
...
func (o *TeamMembershipUser) SetLink(v string) {
	o.Link = v
}

// GetLocation returns the Location field value
// If the value is explicit nil, the zero value for string will be returned
func (o *TeamMembershipUser) GetLocation() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TeamMembershipUser) GetLocationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetLocation(v string) {
	o.Location.Set(&v)
}
...
func (o *TeamMembershipUser) GetLocationDetails() UserLocationDetails {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TeamMembershipUser) GetLocationDetailsOk() (*UserLocationDetails, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetLocationDetails(v UserLocationDetails) {
	o.LocationDetails.Set(&v)
}

// GetMetadata returns the Metadata field value
func (o *TeamMembershipUser) GetMetadata() UserMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetMetadataOk() (*UserMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetMetadata(v UserMetadata) {
	o.Metadata = v
}

// GetName returns the Name field value
func (o *TeamMembershipUser) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *TeamMembershipUser) SetName(v string) {
	o.Name = v
}

// GetPictures returns the Pictures field value
func (o *TeamMembershipUser) GetPictures() Picture {
	if o == nil {
		var ret Picture
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetPicturesOk() (*Picture, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetPictures(v Picture) {
	o.Pictures = v
}

// GetPreferences returns the Preferences field value
func (o *TeamMembershipUser) GetPreferences() UserPreferences {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetPreferencesOk() (*UserPreferences, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetPreferences(v UserPreferences) {
	o.Preferences = v
}

// GetResourceKey returns the ResourceKey field value
func (o *TeamMembershipUser) GetResourceKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetResourceKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetResourceKey(v string) {
	o.ResourceKey = v
}

// GetShortBio returns the ShortBio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *TeamMembershipUser) GetShortBio() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TeamMembershipUser) GetShortBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TeamMembershipUser) GetSkillsOk() ([]Skill, bool) {
...
func (o *TeamMembershipUser) SetSkills(v []Skill) {
	o.Skills = v
}

// GetUploadQuota returns the UploadQuota field value
func (o *TeamMembershipUser) GetUploadQuota() UserUploadQuota {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetUploadQuotaOk() (*UserUploadQuota, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetUploadQuota(v UserUploadQuota) {
	o.UploadQuota = v
}

// GetUri returns the Uri field value
func (o *TeamMembershipUser) GetUri() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uri, true
...
func (o *TeamMembershipUser) SetUri(v string) {
	o.Uri = v
}

// GetWebsites returns the Websites field value
func (o *TeamMembershipUser) GetWebsites() []UserWebsitesInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TeamMembershipUser) GetWebsitesOk() ([]UserWebsitesInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TeamMembershipUser) SetWebsites(v []UserWebsitesInner) {
	o.Websites = v
}

func (o TeamMembershipUser) MarshalJSON() ([]byte, error) {
...
func (o TeamMembershipUser) ToMap() (map[string]interface{}, error) {
...
func (o *TeamMembershipUser) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamMembershipUser := _TeamMembershipUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamMembershipUser)

	if err != nil {
		return err
	}

	*o = TeamMembershipUser(varTeamMembershipUser)

	return err
}

type NullableTeamMembershipUser struct {
	value *TeamMembershipUser
	isSet bool
}

func (v NullableTeamMembershipUser) Get() *TeamMembershipUser {
	return v.value
}

func (v *NullableTeamMembershipUser) Set(val *TeamMembershipUser) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamMembershipUser) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamMembershipUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamMembershipUser(val *TeamMembershipUser) *NullableTeamMembershipUser {
	return &NullableTeamMembershipUser{value: val, isSet: true}
}

func (v NullableTeamMembershipUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamMembershipUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
