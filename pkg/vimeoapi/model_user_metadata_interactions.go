...
type _UserMetadataInteractions UserMetadataInteractions
...
func (o *UserMetadataInteractions) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMetadataInteractions := _UserMetadataInteractions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMetadataInteractions)

	if err != nil {
		return err
	}

	*o = UserMetadataInteractions(varUserMetadataInteractions)
