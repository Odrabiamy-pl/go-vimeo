...
type _AnalyticsMetadataConnectionsVideo AnalyticsMetadataConnectionsVideo
...
func (o *AnalyticsMetadataConnectionsVideo) UnmarshalJSON(data []byte) (err error) {
	...
	varAnalyticsMetadataConnectionsVideo := _AnalyticsMetadataConnectionsVideo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAnalyticsMetadataConnectionsVideo)

	if err != nil {
		return err
	}

	*o = AnalyticsMetadataConnectionsVideo(varAnalyticsMetadataConnectionsVideo)
