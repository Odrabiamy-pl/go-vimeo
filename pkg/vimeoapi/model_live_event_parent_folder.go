...
type _LiveEventParentFolder LiveEventParentFolder
...
func (o *LiveEventParentFolder) UnmarshalJSON(data []byte) (err error) {
	...
	varLiveEventParentFolder := _LiveEventParentFolder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLiveEventParentFolder)

	if err != nil {
		return err
	}

	*o = LiveEventParentFolder(varLiveEventParentFolder)
