...
type _LiveEventMetadataConnectionsPreLiveVideo LiveEventMetadataConnectionsPreLiveVideo
...
func (o *LiveEventMetadataConnectionsPreLiveVideo) UnmarshalJSON(data []byte) (err error) {
	...
	varLiveEventMetadataConnectionsPreLiveVideo := _LiveEventMetadataConnectionsPreLiveVideo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLiveEventMetadataConnectionsPreLiveVideo)

	if err != nil {
		return err
	}

	*o = LiveEventMetadataConnectionsPreLiveVideo(varLiveEventMetadataConnectionsPreLiveVideo)
