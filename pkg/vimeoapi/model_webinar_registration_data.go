...
type _WebinarRegistrationData WebinarRegistrationData
...
func (o *WebinarRegistrationData) UnmarshalJSON(data []byte) (err error) {
	...
	varWebinarRegistrationData := _WebinarRegistrationData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebinarRegistrationData)

	if err != nil {
		return err
	}

	*o = WebinarRegistrationData(varWebinarRegistrationData)
