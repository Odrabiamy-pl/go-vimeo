...
type _LiveEventEmbedLogosCustom LiveEventEmbedLogosCustom
...
func (o *LiveEventEmbedLogosCustom) UnmarshalJSON(data []byte) (err error) {
	...
	varLiveEventEmbedLogosCustom := _LiveEventEmbedLogosCustom{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLiveEventEmbedLogosCustom)

	if err != nil {
		return err
	}

	*o = LiveEventEmbedLogosCustom(varLiveEventEmbedLogosCustom)
