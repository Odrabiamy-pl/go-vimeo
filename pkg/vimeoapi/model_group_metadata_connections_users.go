...
type _GroupMetadataConnectionsUsers GroupMetadataConnectionsUsers
...
func (o *GroupMetadataConnectionsUsers) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupMetadataConnectionsUsers := _GroupMetadataConnectionsUsers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupMetadataConnectionsUsers)

	if err != nil {
		return err
	}

	*o = GroupMetadataConnectionsUsers(varGroupMetadataConnectionsUsers)
