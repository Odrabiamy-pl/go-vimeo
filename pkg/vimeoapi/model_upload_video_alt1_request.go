...
type _UploadVideoAlt1Request UploadVideoAlt1Request
...
func (o *UploadVideoAlt1Request) UnmarshalJSON(data []byte) (err error) {
	...
	varUploadVideoAlt1Request := _UploadVideoAlt1Request{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUploadVideoAlt1Request)

	if err != nil {
		return err
	}

	*o = UploadVideoAlt1Request(varUploadVideoAlt1Request)
