...
type _EmbedSettingsLogosCustom EmbedSettingsLogosCustom
...
func (o *EmbedSettingsLogosCustom) UnmarshalJSON(data []byte) (err error) {
	...
	varEmbedSettingsLogosCustom := _EmbedSettingsLogosCustom{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmbedSettingsLogosCustom)

	if err != nil {
		return err
	}

	*o = EmbedSettingsLogosCustom(varEmbedSettingsLogosCustom)
