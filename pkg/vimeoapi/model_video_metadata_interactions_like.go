...
type _VideoMetadataInteractionsLike VideoMetadataInteractionsLike
...
func (o *VideoMetadataInteractionsLike) UnmarshalJSON(data []byte) (err error) {
	...
	varVideoMetadataInteractionsLike := _VideoMetadataInteractionsLike{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVideoMetadataInteractionsLike)

	if err != nil {
		return err
	}

	*o = VideoMetadataInteractionsLike(varVideoMetadataInteractionsLike)
