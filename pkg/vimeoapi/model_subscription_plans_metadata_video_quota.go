...
type _SubscriptionPlansMetadataVideoQuota SubscriptionPlansMetadataVideoQuota
...
func (o *SubscriptionPlansMetadataVideoQuota) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPlansMetadataVideoQuota := _SubscriptionPlansMetadataVideoQuota{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPlansMetadataVideoQuota)

	if err != nil {
		return err
	}

	*o = SubscriptionPlansMetadataVideoQuota(varSubscriptionPlansMetadataVideoQuota)
