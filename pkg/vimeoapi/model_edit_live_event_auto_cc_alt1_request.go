...
type _EditLiveEventAutoCcAlt1Request EditLiveEventAutoCcAlt1Request
...
func (o *EditLiveEventAutoCcAlt1Request) UnmarshalJSON(data []byte) (err error) {
	...
	varEditLiveEventAutoCcAlt1Request := _EditLiveEventAutoCcAlt1Request{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEditLiveEventAutoCcAlt1Request)

	if err != nil {
		return err
	}

	*o = EditLiveEventAutoCcAlt1Request(varEditLiveEventAutoCcAlt1Request)
