...
type _VersionTranscodeStatus VersionTranscodeStatus
...
func (o *VersionTranscodeStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varVersionTranscodeStatus := _VersionTranscodeStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVersionTranscodeStatus)

	if err != nil {
		return err
	}

	*o = VersionTranscodeStatus(varVersionTranscodeStatus)
