...
type _OnDemandPageSubscription OnDemandPageSubscription
...
func (o *OnDemandPageSubscription) UnmarshalJSON(data []byte) (err error) {
	...
	varOnDemandPageSubscription := _OnDemandPageSubscription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOnDemandPageSubscription)

	if err != nil {
		return err
	}

	*o = OnDemandPageSubscription(varOnDemandPageSubscription)
