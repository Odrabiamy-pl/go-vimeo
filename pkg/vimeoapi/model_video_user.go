...
func (o *VideoUser) UnmarshalJSON(data []byte) (err error) {
	...
	varVideoUser := _VideoUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVideoUser)

	if err != nil {
		return err
	}

	*o = VideoUser(varVideoUser)
