...
type _EmbedSettingsEndScreen EmbedSettingsEndScreen
...
func (o *EmbedSettingsEndScreen) UnmarshalJSON(data []byte) (err error) {
	...
	varEmbedSettingsEndScreen := _EmbedSettingsEndScreen{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmbedSettingsEndScreen)

	if err != nil {
		return err
	}

	*o = EmbedSettingsEndScreen(varEmbedSettingsEndScreen)
