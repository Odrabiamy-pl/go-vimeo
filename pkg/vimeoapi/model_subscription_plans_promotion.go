...
type _SubscriptionPlansPromotion SubscriptionPlansPromotion
...
func (o *SubscriptionPlansPromotion) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPlansPromotion := _SubscriptionPlansPromotion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPlansPromotion)

	if err != nil {
		return err
	}

	*o = SubscriptionPlansPromotion(varSubscriptionPlansPromotion)
