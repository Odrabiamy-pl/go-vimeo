...
type _UserMetadataInteractionsBlock UserMetadataInteractionsBlock
...
func (o *UserMetadataInteractionsBlock) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMetadataInteractionsBlock := _UserMetadataInteractionsBlock{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMetadataInteractionsBlock)

	if err != nil {
		return err
	}

	*o = UserMetadataInteractionsBlock(varUserMetadataInteractionsBlock)
