...
type _CreateVodPromotionRequest CreateVodPromotionRequest
...
func (o *CreateVodPromotionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateVodPromotionRequest := _CreateVodPromotionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateVodPromotionRequest)

	if err != nil {
		return err
	}

	*o = CreateVodPromotionRequest(varCreateVodPromotionRequest)
