...
type _LiveEventSessionStatusArchive LiveEventSessionStatusArchive
...
func (o *LiveEventSessionStatusArchive) UnmarshalJSON(data []byte) (err error) {
	...
	varLiveEventSessionStatusArchive := _LiveEventSessionStatusArchive{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLiveEventSessionStatusArchive)

	if err != nil {
		return err
	}

	*o = LiveEventSessionStatusArchive(varLiveEventSessionStatusArchive)
