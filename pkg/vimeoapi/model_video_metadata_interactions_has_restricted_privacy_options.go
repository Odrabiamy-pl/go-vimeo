...
type _VideoMetadataInteractionsHasRestrictedPrivacyOptions VideoMetadataInteractionsHasRestrictedPrivacyOptions
...
func (o *VideoMetadataInteractionsHasRestrictedPrivacyOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varVideoMetadataInteractionsHasRestrictedPrivacyOptions := _VideoMetadataInteractionsHasRestrictedPrivacyOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVideoMetadataInteractionsHasRestrictedPrivacyOptions)

	if err != nil {
		return err
	}

	*o = VideoMetadataInteractionsHasRestrictedPrivacyOptions(varVideoMetadataInteractionsHasRestrictedPrivacyOptions)
