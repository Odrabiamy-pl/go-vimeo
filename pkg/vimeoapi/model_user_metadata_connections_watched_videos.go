...
type _UserMetadataConnectionsWatchedVideos UserMetadataConnectionsWatchedVideos
...
func (o *UserMetadataConnectionsWatchedVideos) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMetadataConnectionsWatchedVideos := _UserMetadataConnectionsWatchedVideos{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMetadataConnectionsWatchedVideos)

	if err != nil {
		return err
	}

	*o = UserMetadataConnectionsWatchedVideos(varUserMetadataConnectionsWatchedVideos)
