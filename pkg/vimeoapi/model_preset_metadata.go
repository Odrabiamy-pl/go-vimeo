...
type _PresetMetadata PresetMetadata
...
func (o *PresetMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varPresetMetadata := _PresetMetadata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPresetMetadata)

	if err != nil {
		return err
	}

	*o = PresetMetadata(varPresetMetadata)
