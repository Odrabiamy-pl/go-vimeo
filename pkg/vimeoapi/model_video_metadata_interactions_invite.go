...
type _VideoMetadataInteractionsInvite VideoMetadataInteractionsInvite
...
func (o *VideoMetadataInteractionsInvite) UnmarshalJSON(data []byte) (err error) {
	...
	varVideoMetadataInteractionsInvite := _VideoMetadataInteractionsInvite{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVideoMetadataInteractionsInvite)

	if err != nil {
		return err
	}

	*o = VideoMetadataInteractionsInvite(varVideoMetadataInteractionsInvite)
