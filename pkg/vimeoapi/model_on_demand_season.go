...
type _OnDemandSeason OnDemandSeason
...
func (o *OnDemandSeason) UnmarshalJSON(data []byte) (err error) {
	...
	varOnDemandSeason := _OnDemandSeason{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOnDemandSeason)

	if err != nil {
		return err
	}

	*o = OnDemandSeason(varOnDemandSeason)
