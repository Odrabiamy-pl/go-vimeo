...
// checks if the WebinarEmailSettingsFollowUpSender type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebinarEmailSettingsFollowUpSender{}

// WebinarEmailSettingsFollowUpSender The user who manually triggered the follow-up email.
type WebinarEmailSettingsFollowUpSender struct {
...
type _WebinarEmailSettingsFollowUpSender WebinarEmailSettingsFollowUpSender

// NewWebinarEmailSettingsFollowUpSender instantiates a new WebinarEmailSettingsFollowUpSender object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWebinarEmailSettingsFollowUpSender(account string, availableForHire bool, bio NullableString, canWorkRemotely bool, capabilities map[string]interface{}, clients string, createdTime string, gender NullableString, hasInvalidEmail bool, isExpert bool, link string, location NullableString, locationDetails NullableUserLocationDetails, metadata UserMetadata, name string, pictures Picture, preferences UserPreferences, resourceKey string, shortBio NullableString, skills []Skill, uploadQuota UserUploadQuota, uri string, websites []UserWebsitesInner) *WebinarEmailSettingsFollowUpSender {
	this := WebinarEmailSettingsFollowUpSender{}
...
// NewWebinarEmailSettingsFollowUpSenderWithDefaults instantiates a new WebinarEmailSettingsFollowUpSender object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWebinarEmailSettingsFollowUpSenderWithDefaults() *WebinarEmailSettingsFollowUpSender {
	this := WebinarEmailSettingsFollowUpSender{}
	return &this
}

// GetAccount returns the Account field value
func (o *WebinarEmailSettingsFollowUpSender) GetAccount() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *WebinarEmailSettingsFollowUpSender) GetAccountOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetAccount(v string) {
	o.Account = v
}

// GetAvailableForHire returns the AvailableForHire field value
func (o *WebinarEmailSettingsFollowUpSender) GetAvailableForHire() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetAvailableForHireOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetAvailableForHire(v bool) {
	o.AvailableForHire = v
}

// GetBio returns the Bio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetBio() string {
...
func (o *WebinarEmailSettingsFollowUpSender) GetBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetBio(v string) {
	o.Bio.Set(&v)
}

// GetCanWorkRemotely returns the CanWorkRemotely field value
func (o *WebinarEmailSettingsFollowUpSender) GetCanWorkRemotely() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetCanWorkRemotelyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetCanWorkRemotely(v bool) {
	o.CanWorkRemotely = v
}

// GetCapabilities returns the Capabilities field value
func (o *WebinarEmailSettingsFollowUpSender) GetCapabilities() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetCapabilitiesOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *WebinarEmailSettingsFollowUpSender) SetCapabilities(v map[string]interface{}) {
	o.Capabilities = v
}

// GetClients returns the Clients field value
func (o *WebinarEmailSettingsFollowUpSender) GetClients() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetClientsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetClients(v string) {
	o.Clients = v
}

// GetContentFilter returns the ContentFilter field value if set, zero value otherwise.
func (o *WebinarEmailSettingsFollowUpSender) GetContentFilter() []string {
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetContentFilterOk() ([]string, bool) {
	if o == nil || IsNil(o.ContentFilter) {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) HasContentFilter() bool {
	if o != nil && !IsNil(o.ContentFilter) {
		return true
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetContentFilter(v []string) {
	o.ContentFilter = v
}

// GetCreatedTime returns the CreatedTime field value
func (o *WebinarEmailSettingsFollowUpSender) GetCreatedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetCreatedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetCreatedTime(v string) {
	o.CreatedTime = v
}

// GetGender returns the Gender field value
// If the value is explicit nil, the zero value for string will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetGender() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetGenderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetGender(v string) {
	o.Gender.Set(&v)
}

// GetHasInvalidEmail returns the HasInvalidEmail field value
func (o *WebinarEmailSettingsFollowUpSender) GetHasInvalidEmail() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetHasInvalidEmailOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetHasInvalidEmail(v bool) {
	o.HasInvalidEmail = v
}

// GetIsExpert returns the IsExpert field value
func (o *WebinarEmailSettingsFollowUpSender) GetIsExpert() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetIsExpertOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetIsExpert(v bool) {
	o.IsExpert = v
}

// GetLink returns the Link field value
func (o *WebinarEmailSettingsFollowUpSender) GetLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Link, true
...
func (o *WebinarEmailSettingsFollowUpSender) SetLink(v string) {
	o.Link = v
}

// GetLocation returns the Location field value
// If the value is explicit nil, the zero value for string will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetLocation() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetLocationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetLocation(v string) {
	o.Location.Set(&v)
}
...
func (o *WebinarEmailSettingsFollowUpSender) GetLocationDetails() UserLocationDetails {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetLocationDetailsOk() (*UserLocationDetails, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetLocationDetails(v UserLocationDetails) {
	o.LocationDetails.Set(&v)
}

// GetMetadata returns the Metadata field value
func (o *WebinarEmailSettingsFollowUpSender) GetMetadata() UserMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetMetadataOk() (*UserMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetMetadata(v UserMetadata) {
	o.Metadata = v
}

// GetName returns the Name field value
func (o *WebinarEmailSettingsFollowUpSender) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *WebinarEmailSettingsFollowUpSender) SetName(v string) {
	o.Name = v
}

// GetPictures returns the Pictures field value
func (o *WebinarEmailSettingsFollowUpSender) GetPictures() Picture {
	if o == nil {
		var ret Picture
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetPicturesOk() (*Picture, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetPictures(v Picture) {
	o.Pictures = v
}

// GetPreferences returns the Preferences field value
func (o *WebinarEmailSettingsFollowUpSender) GetPreferences() UserPreferences {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetPreferencesOk() (*UserPreferences, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetPreferences(v UserPreferences) {
	o.Preferences = v
}

// GetResourceKey returns the ResourceKey field value
func (o *WebinarEmailSettingsFollowUpSender) GetResourceKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetResourceKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetResourceKey(v string) {
	o.ResourceKey = v
}

// GetShortBio returns the ShortBio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetShortBio() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetShortBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetShortBio(v string) {
	o.ShortBio.Set(&v)
}

// GetSkills returns the Skills field value
// If the value is explicit nil, the zero value for []Skill will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetSkills() []Skill {
	if o == nil {
		var ret []Skill
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebinarEmailSettingsFollowUpSender) GetSkillsOk() ([]Skill, bool) {
...
func (o *WebinarEmailSettingsFollowUpSender) SetSkills(v []Skill) {
	o.Skills = v
}

// GetUploadQuota returns the UploadQuota field value
func (o *WebinarEmailSettingsFollowUpSender) GetUploadQuota() UserUploadQuota {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetUploadQuotaOk() (*UserUploadQuota, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetUploadQuota(v UserUploadQuota) {
	o.UploadQuota = v
}

// GetUri returns the Uri field value
func (o *WebinarEmailSettingsFollowUpSender) GetUri() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uri, true
...
func (o *WebinarEmailSettingsFollowUpSender) SetUri(v string) {
	o.Uri = v
}

// GetWebsites returns the Websites field value
func (o *WebinarEmailSettingsFollowUpSender) GetWebsites() []UserWebsitesInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WebinarEmailSettingsFollowUpSender) GetWebsitesOk() ([]UserWebsitesInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebinarEmailSettingsFollowUpSender) SetWebsites(v []UserWebsitesInner) {
	o.Websites = v
}

func (o WebinarEmailSettingsFollowUpSender) MarshalJSON() ([]byte, error) {
...
func (o WebinarEmailSettingsFollowUpSender) ToMap() (map[string]interface{}, error) {
...
func (o *WebinarEmailSettingsFollowUpSender) UnmarshalJSON(data []byte) (err error) {
	...
	varWebinarEmailSettingsFollowUpSender := _WebinarEmailSettingsFollowUpSender{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebinarEmailSettingsFollowUpSender)

	if err != nil {
		return err
	}

	*o = WebinarEmailSettingsFollowUpSender(varWebinarEmailSettingsFollowUpSender)

	return err
}

type NullableWebinarEmailSettingsFollowUpSender struct {
	value *WebinarEmailSettingsFollowUpSender
	isSet bool
}

func (v NullableWebinarEmailSettingsFollowUpSender) Get() *WebinarEmailSettingsFollowUpSender {
	return v.value
}

func (v *NullableWebinarEmailSettingsFollowUpSender) Set(val *WebinarEmailSettingsFollowUpSender) {
	v.value = val
	v.isSet = true
}

func (v NullableWebinarEmailSettingsFollowUpSender) IsSet() bool {
	return v.isSet
}

func (v *NullableWebinarEmailSettingsFollowUpSender) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebinarEmailSettingsFollowUpSender(val *WebinarEmailSettingsFollowUpSender) *NullableWebinarEmailSettingsFollowUpSender {
	return &NullableWebinarEmailSettingsFollowUpSender{value: val, isSet: true}
}

func (v NullableWebinarEmailSettingsFollowUpSender) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebinarEmailSettingsFollowUpSender) UnmarshalJSON(src []byte) error {
	v.isSet = true
