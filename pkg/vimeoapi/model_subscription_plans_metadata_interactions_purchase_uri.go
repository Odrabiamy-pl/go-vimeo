...
type _SubscriptionPlansMetadataInteractionsPurchaseUri SubscriptionPlansMetadataInteractionsPurchaseUri
...
func (o *SubscriptionPlansMetadataInteractionsPurchaseUri) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPlansMetadataInteractionsPurchaseUri := _SubscriptionPlansMetadataInteractionsPurchaseUri{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPlansMetadataInteractionsPurchaseUri)

	if err != nil {
		return err
	}

	*o = SubscriptionPlansMetadataInteractionsPurchaseUri(varSubscriptionPlansMetadataInteractionsPurchaseUri)
