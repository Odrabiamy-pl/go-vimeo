...
type _UserMetadataConnectionsFolders UserMetadataConnectionsFolders
...
func (o *UserMetadataConnectionsFolders) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMetadataConnectionsFolders := _UserMetadataConnectionsFolders{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMetadataConnectionsFolders)

	if err != nil {
		return err
	}

	*o = UserMetadataConnectionsFolders(varUserMetadataConnectionsFolders)
