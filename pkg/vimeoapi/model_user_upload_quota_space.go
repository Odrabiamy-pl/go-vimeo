...
type _UserUploadQuotaSpace UserUploadQuotaSpace
...
func (o *UserUploadQuotaSpace) UnmarshalJSON(data []byte) (err error) {
	...
	varUserUploadQuotaSpace := _UserUploadQuotaSpace{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserUploadQuotaSpace)

	if err != nil {
		return err
	}

	*o = UserUploadQuotaSpace(varUserUploadQuotaSpace)
