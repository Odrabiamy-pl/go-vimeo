...
type _VideoMetadataConnectionsComments VideoMetadataConnectionsComments
...
func (o *VideoMetadataConnectionsComments) UnmarshalJSON(data []byte) (err error) {
	...
	varVideoMetadataConnectionsComments := _VideoMetadataConnectionsComments{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVideoMetadataConnectionsComments)

	if err != nil {
		return err
	}

	*o = VideoMetadataConnectionsComments(varVideoMetadataConnectionsComments)
