...
type _CreateCommentReplyRequest CreateCommentReplyRequest
...
func (o *CreateCommentReplyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCommentReplyRequest := _CreateCommentReplyRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCommentReplyRequest)

	if err != nil {
		return err
	}

	*o = CreateCommentReplyRequest(varCreateCommentReplyRequest)
