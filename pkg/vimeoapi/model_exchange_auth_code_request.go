...
type _ExchangeAuthCodeRequest ExchangeAuthCodeRequest
...
func (o *ExchangeAuthCodeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varExchangeAuthCodeRequest := _ExchangeAuthCodeRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExchangeAuthCodeRequest)

	if err != nil {
		return err
	}

	*o = ExchangeAuthCodeRequest(varExchangeAuthCodeRequest)
