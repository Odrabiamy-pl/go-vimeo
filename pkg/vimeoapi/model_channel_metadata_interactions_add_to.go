...
type _ChannelMetadataInteractionsAddTo ChannelMetadataInteractionsAddTo
...
func (o *ChannelMetadataInteractionsAddTo) UnmarshalJSON(data []byte) (err error) {
	...
	varChannelMetadataInteractionsAddTo := _ChannelMetadataInteractionsAddTo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChannelMetadataInteractionsAddTo)

	if err != nil {
		return err
	}

	*o = ChannelMetadataInteractionsAddTo(varChannelMetadataInteractionsAddTo)
