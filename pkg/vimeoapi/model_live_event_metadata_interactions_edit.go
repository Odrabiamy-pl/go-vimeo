...
type _LiveEventMetadataInteractionsEdit LiveEventMetadataInteractionsEdit
...
func (o *LiveEventMetadataInteractionsEdit) UnmarshalJSON(data []byte) (err error) {
	...
	varLiveEventMetadataInteractionsEdit := _LiveEventMetadataInteractionsEdit{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLiveEventMetadataInteractionsEdit)

	if err != nil {
		return err
	}

	*o = LiveEventMetadataInteractionsEdit(varLiveEventMetadataInteractionsEdit)
