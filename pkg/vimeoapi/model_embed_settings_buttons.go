...
type _EmbedSettingsButtons EmbedSettingsButtons
...
func (o *EmbedSettingsButtons) UnmarshalJSON(data []byte) (err error) {
	...
	varEmbedSettingsButtons := _EmbedSettingsButtons{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmbedSettingsButtons)

	if err != nil {
		return err
	}

	*o = EmbedSettingsButtons(varEmbedSettingsButtons)
