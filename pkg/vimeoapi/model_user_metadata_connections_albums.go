...
type _UserMetadataConnectionsAlbums UserMetadataConnectionsAlbums
...
func (o *UserMetadataConnectionsAlbums) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMetadataConnectionsAlbums := _UserMetadataConnectionsAlbums{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMetadataConnectionsAlbums)

	if err != nil {
		return err
	}

	*o = UserMetadataConnectionsAlbums(varUserMetadataConnectionsAlbums)
