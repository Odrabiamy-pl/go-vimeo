...
type _EmbedSettingsCardsInner EmbedSettingsCardsInner
...
func (o *EmbedSettingsCardsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varEmbedSettingsCardsInner := _EmbedSettingsCardsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmbedSettingsCardsInner)

	if err != nil {
		return err
	}

	*o = EmbedSettingsCardsInner(varEmbedSettingsCardsInner)
