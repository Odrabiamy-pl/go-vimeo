...
func (o *LegacyError) UnmarshalJSON(data []byte) (err error) {
	...
	varLegacyError := _LegacyError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLegacyError)

	if err != nil {
		return err
	}

	*o = LegacyError(varLegacyError)
