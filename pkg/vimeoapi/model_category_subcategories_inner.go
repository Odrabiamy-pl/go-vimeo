...
type _CategorySubcategoriesInner CategorySubcategoriesInner
...
func (o *CategorySubcategoriesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCategorySubcategoriesInner := _CategorySubcategoriesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCategorySubcategoriesInner)

	if err != nil {
		return err
	}

	*o = CategorySubcategoriesInner(varCategorySubcategoriesInner)
