...
var _ MappedNullable = &VideoVersionUser{}

// VideoVersionUser The owner of the video version.
type VideoVersionUser struct {
...
// NewVideoVersionUserWithDefaults instantiates a new VideoVersionUser object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewVideoVersionUserWithDefaults() *VideoVersionUser {
	this := VideoVersionUser{}
	return &this
}

// GetAccount returns the Account field value
func (o *VideoVersionUser) GetAccount() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *VideoVersionUser) GetAccountOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetAccount(v string) {
	o.Account = v
}

// GetAvailableForHire returns the AvailableForHire field value
func (o *VideoVersionUser) GetAvailableForHire() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetAvailableForHireOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetAvailableForHire(v bool) {
	o.AvailableForHire = v
}

// GetBio returns the Bio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *VideoVersionUser) GetBio() string {
...
func (o *VideoVersionUser) GetBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetBio(v string) {
	o.Bio.Set(&v)
}

// GetCanWorkRemotely returns the CanWorkRemotely field value
func (o *VideoVersionUser) GetCanWorkRemotely() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetCanWorkRemotelyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetCanWorkRemotely(v bool) {
	o.CanWorkRemotely = v
}

// GetCapabilities returns the Capabilities field value
func (o *VideoVersionUser) GetCapabilities() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetCapabilitiesOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *VideoVersionUser) SetCapabilities(v map[string]interface{}) {
	o.Capabilities = v
}

// GetClients returns the Clients field value
func (o *VideoVersionUser) GetClients() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetClientsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetClients(v string) {
	o.Clients = v
}

// GetContentFilter returns the ContentFilter field value if set, zero value otherwise.
func (o *VideoVersionUser) GetContentFilter() []string {
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetContentFilterOk() ([]string, bool) {
	if o == nil || IsNil(o.ContentFilter) {
		return nil, false
	}
...
func (o *VideoVersionUser) HasContentFilter() bool {
	if o != nil && !IsNil(o.ContentFilter) {
		return true
	}
...
func (o *VideoVersionUser) SetContentFilter(v []string) {
	o.ContentFilter = v
}

// GetCreatedTime returns the CreatedTime field value
func (o *VideoVersionUser) GetCreatedTime() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetCreatedTimeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetCreatedTime(v string) {
	o.CreatedTime = v
}

// GetGender returns the Gender field value
// If the value is explicit nil, the zero value for string will be returned
func (o *VideoVersionUser) GetGender() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VideoVersionUser) GetGenderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetGender(v string) {
	o.Gender.Set(&v)
}

// GetHasInvalidEmail returns the HasInvalidEmail field value
func (o *VideoVersionUser) GetHasInvalidEmail() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetHasInvalidEmailOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetHasInvalidEmail(v bool) {
	o.HasInvalidEmail = v
}

// GetIsExpert returns the IsExpert field value
func (o *VideoVersionUser) GetIsExpert() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetIsExpertOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetIsExpert(v bool) {
	o.IsExpert = v
}

// GetLink returns the Link field value
func (o *VideoVersionUser) GetLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Link, true
...
func (o *VideoVersionUser) SetLink(v string) {
	o.Link = v
}

// GetLocation returns the Location field value
// If the value is explicit nil, the zero value for string will be returned
func (o *VideoVersionUser) GetLocation() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VideoVersionUser) GetLocationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetLocation(v string) {
	o.Location.Set(&v)
}
...
func (o *VideoVersionUser) GetLocationDetails() UserLocationDetails {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VideoVersionUser) GetLocationDetailsOk() (*UserLocationDetails, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetLocationDetails(v UserLocationDetails) {
	o.LocationDetails.Set(&v)
}

// GetMetadata returns the Metadata field value
func (o *VideoVersionUser) GetMetadata() UserMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetMetadataOk() (*UserMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetMetadata(v UserMetadata) {
	o.Metadata = v
}

// GetName returns the Name field value
func (o *VideoVersionUser) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *VideoVersionUser) SetName(v string) {
	o.Name = v
}

// GetPictures returns the Pictures field value
func (o *VideoVersionUser) GetPictures() Picture {
	if o == nil {
		var ret Picture
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetPicturesOk() (*Picture, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetPictures(v Picture) {
	o.Pictures = v
}

// GetPreferences returns the Preferences field value
func (o *VideoVersionUser) GetPreferences() UserPreferences {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetPreferencesOk() (*UserPreferences, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetPreferences(v UserPreferences) {
	o.Preferences = v
}

// GetResourceKey returns the ResourceKey field value
func (o *VideoVersionUser) GetResourceKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetResourceKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetResourceKey(v string) {
	o.ResourceKey = v
}

// GetShortBio returns the ShortBio field value
// If the value is explicit nil, the zero value for string will be returned
func (o *VideoVersionUser) GetShortBio() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VideoVersionUser) GetShortBioOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VideoVersionUser) GetSkillsOk() ([]Skill, bool) {
...
func (o *VideoVersionUser) SetSkills(v []Skill) {
	o.Skills = v
}

// GetUploadQuota returns the UploadQuota field value
func (o *VideoVersionUser) GetUploadQuota() UserUploadQuota {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetUploadQuotaOk() (*UserUploadQuota, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetUploadQuota(v UserUploadQuota) {
	o.UploadQuota = v
}

// GetUri returns the Uri field value
func (o *VideoVersionUser) GetUri() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uri, true
...
func (o *VideoVersionUser) SetUri(v string) {
	o.Uri = v
}

// GetWebsites returns the Websites field value
func (o *VideoVersionUser) GetWebsites() []UserWebsitesInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *VideoVersionUser) GetWebsitesOk() ([]UserWebsitesInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VideoVersionUser) SetWebsites(v []UserWebsitesInner) {
	o.Websites = v
}

func (o VideoVersionUser) MarshalJSON() ([]byte, error) {
...
func (o VideoVersionUser) ToMap() (map[string]interface{}, error) {
...
type NullableVideoVersionUser struct {
	value *VideoVersionUser
	isSet bool
}

func (v NullableVideoVersionUser) Get() *VideoVersionUser {
	return v.value
}

func (v *NullableVideoVersionUser) Set(val *VideoVersionUser) {
	v.value = val
	v.isSet = true
}

func (v NullableVideoVersionUser) IsSet() bool {
	return v.isSet
}

func (v *NullableVideoVersionUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideoVersionUser(val *VideoVersionUser) *NullableVideoVersionUser {
	return &NullableVideoVersionUser{value: val, isSet: true}
}

func (v NullableVideoVersionUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoVersionUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
