...
type _DisabledVideoPropertiesAddToCollection DisabledVideoPropertiesAddToCollection
...
func (o *DisabledVideoPropertiesAddToCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varDisabledVideoPropertiesAddToCollection := _DisabledVideoPropertiesAddToCollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDisabledVideoPropertiesAddToCollection)

	if err != nil {
		return err
	}

	*o = DisabledVideoPropertiesAddToCollection(varDisabledVideoPropertiesAddToCollection)
