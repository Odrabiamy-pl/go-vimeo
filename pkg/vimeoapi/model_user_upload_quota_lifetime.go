...
type _UserUploadQuotaLifetime UserUploadQuotaLifetime
...
func (o *UserUploadQuotaLifetime) UnmarshalJSON(data []byte) (err error) {
	...
	varUserUploadQuotaLifetime := _UserUploadQuotaLifetime{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserUploadQuotaLifetime)

	if err != nil {
		return err
	}

	*o = UserUploadQuotaLifetime(varUserUploadQuotaLifetime)
