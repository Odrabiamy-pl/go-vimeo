...
type _SetVodRegionsRequest SetVodRegionsRequest
...
func (o *SetVodRegionsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetVodRegionsRequest := _SetVodRegionsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetVodRegionsRequest)

	if err != nil {
		return err
	}

	*o = SetVodRegionsRequest(varSetVodRegionsRequest)
