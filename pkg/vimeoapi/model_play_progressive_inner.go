...
type _PlayProgressiveInner PlayProgressiveInner
...
func (o *PlayProgressiveInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPlayProgressiveInner := _PlayProgressiveInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPlayProgressiveInner)

	if err != nil {
		return err
	}

	*o = PlayProgressiveInner(varPlayProgressiveInner)
