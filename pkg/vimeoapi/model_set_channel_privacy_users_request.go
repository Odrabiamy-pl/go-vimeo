...
type _SetChannelPrivacyUsersRequest SetChannelPrivacyUsersRequest
...
func (o *SetChannelPrivacyUsersRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetChannelPrivacyUsersRequest := _SetChannelPrivacyUsersRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetChannelPrivacyUsersRequest)

	if err != nil {
		return err
	}

	*o = SetChannelPrivacyUsersRequest(varSetChannelPrivacyUsersRequest)
